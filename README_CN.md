...
**[AI-Protocol](https://github.com/ailib-official/ai-protocol) 协议运行时** — 异步 Python 参考实现（v**1.2.0**）。
...
已发布至 [PyPI](https://pypi.org/project/ai-lib-python/)：**`ai-lib-python` 1.2.0**。需要 Python **3.10+**。
